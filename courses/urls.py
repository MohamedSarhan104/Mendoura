...
urlpatterns = [
    ...
    path('course/<int:course_id>/wizard/', views.course_wizard_resume, name='course_wizard_resume'),
    path('course/<int:course_id>/wizard/modules/', views.course_wizard_modules, name='course_wizard_modules'),
    path('course/<int:course_id>/wizard/modules/<int:module_id>/', views.course_wizard_module_content,
         name='course_wizard_module_content'),
    path('course/<int:course_id>/wizard/review/', views.course_wizard_review, name='course_wizard_review'),
    ...
    path('lectures/<int:lecture_id>/generate-transcript/', views.generate_lecture_transcript,
         name='generate_lecture_transcript'),
    path('lectures/<int:lecture_id>/transcript-status/', views.lecture_transcript_status,
         name='lecture_transcript_status'),
    ...
    path('course/<int:course_id>/modules/<int:module_id>/quiz/', views.manage_quiz, name='manage_quiz'),
    path('course/<int:course_id>/modules/<int:module_id>/quiz/delete/', views.delete_quiz, name='delete_quiz'),
    path('course/<int:course_id>/modules/<int:module_id>/quiz/questions/', views.add_question,
         name='add_question'),
    ...
    path('questions/<int:question_id>/choices/', views.add_choice, name='add_choice'),
    path('choices/<int:choice_id>/mark-correct/', views.mark_choice_correct, name='mark_choice_correct'),
    ...
    path('learn/<int:course_id>/modules/<int:module_id>/quiz/', views.take_quiz, name='take_quiz'),
    path('learn/<int:course_id>/modules/<int:module_id>/quiz/attempts/<int:attempt_id>/',
